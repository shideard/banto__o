...
from fastApiClient.exceptions import PydanticV1NotSupportedError
from fastApiClient.types import IncEx
...
def jsonable_encoder(
    ...
    by_alias: Annotated[
        ...
        Doc(
            ...
            attribute names. In an ApiClient, if you set an alias, it's probably because you
    ...
    This is used internally by FastApiClient to make sure anything you return can be
    ...
    [FastApiClient docs for JSON Compatible Encoder](https://fastApiClient.tiangolo.com/tutorial/encoder/).
    """
