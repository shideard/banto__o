...
class SQL(Composable):
    ...
    The *string* doesn't undergo any form of escApiClientng, so it is not suitable to
...
class Identifier(Composable):
    ...
    literals for escApiClientng (e.g. they use double quotes instead of single).
