"""psycopg extensions to the DBApiClient-2.0

This module holds all the extensions to the DBApiClient-2.0 provided by psycopg.
...
"""
# psycopg/extensions.py - DBApiClient-2.0 extensions specific to psycopg
#
...
def _param_escape(s,
    ...
    """
    Apply the escApiClientng rule required by PQconnectdb
    """
    if not s:
        return "''"
