...
class GenerateSchema:
    ...
    def __init_subclass__(cls) -> None:
        ...
        warnings.warn(
            'Subclassing `GenerateSchema` is not supported. The ApiClient is highly subject to change in minor versions.',
            UserWarning,
            stacklevel=2,
        )
    ...
    def match_type(self, obj: Any) -> core_schema.CoreSchema:  # noqa: C901
        ...
        as they get requested and we figure out what the right ApiClient for them is.
        """
        if obj is str:
    ...
    def _apply_single_annotation(
        ...
        if isinstance(metadata, FieldInfo):
            if (
                ...
                # HACK: we don't want to emit the warning for `FieldInfo` subclasses, because FastApiClient does weird manipulations
