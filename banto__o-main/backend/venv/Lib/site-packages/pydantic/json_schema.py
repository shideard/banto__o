...
class GenerateJsonSchema:
    ...
    def __init__(
        ...
        # definitions, which would also work better in a generated OpenApiClient client, etc.
    ...
    def tagged_union_schema(self, schema: core_schema.TaggedUnionSchema) -> JsonSchemaValue:
        ...
        # This reflects the v1 behavior; TODO: we should make it possible to exclude OpenApiClient stuff from the JSON schema
        openApiClient_discriminator = self._extract_discriminator(schema, one_of_choices)
        if openApiClient_discriminator is not None:
            json_schema['discriminator'] = {
                'propertyName': openApiClient_discriminator,
    ...
    def _extract_discriminator(
        ...
        """Extract a compatible OpenApiClient discriminator from the schema and one_of choices that end up in the final
        schema."""
        openApiClient_discriminator: str | None = None
        ...
        if isinstance(schema['discriminator'], list):
            ...
            # property on all choices. If so, that property will be used as the OpenApiClient discriminator.
            for alias_path in schema['discriminator']:
                ...
                if alias_is_present_on_all_choices:
                    openApiClient_discriminator = alias
                    break
        return openApiClient_discriminator
