...
namespace greenlet
{
    ...
    IsShuttingDown()
    {
        ...
        // destructor function for our PyCapsule object (_C_ApiClient) to
        ...
        // C_ApiClient to get GC'd early without seriously poking at CPython
        ...
        // _PyGreenlet_ApiClient with different values at destruction time.
        // For the PyObject* returning ApiClients, we could replace them
        ...
        // ApiClients would be handled on a case-by-case basis; unclear what
...
namespace greenlet {
    ...
    public:
        ...
        // conversion to PyObject* for passing to C ApiClient calls and even
    ...
    inline const std::string PyObjectPointer<T, TC>::as_str() const noexcept
    {
        ...
        if (this->p) {
            // The Python ApiClients return a cached char* value that's only valid
    ...
    public:
        ...
        // It is safe to pass a null value to this ApiClient because we use
