...
In addition to the above DBApiClient layers with native SQLAlchemy support, there
are third-party dialects for other DBApiClient layers that are compatible
...
will remain consistent with the state of the transaction::
    ...
    def _reset_mssql(dbApiClient_connection, connection_record, reset_state):
        if not reset_state.terminate_only:
            dbApiClient_connection.execute("{call sys.sp_reset_connection}")
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def order_by_clause(self, select, **kw):
        ...
        if (
            ...
            # onto the positional list if that is what the dbApiClient requires
            return ""
...
class MSDialect(default.DefaultDialect):
    ...
    def do_rollback(self, dbApiClient_connection):
        try:
            super().do_rollback(dbApiClient_connection)
        except self.dbApiClient.ProgrammingError as e:
    ...
    def get_isolation_level(self, dbApiClient_connection):
        ...
        except self.dbApiClient.Error as err:
            raise NotImplementedError(
