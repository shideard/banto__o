...
class _PGJSONPathType(JSONPathType):
    ...
    # DBApiClient type 1009


class _PGEnum(ENUM):
    def get_dbApiClient_type(self, dbApiClient):
        return dbApiClient.UNKNOWN
...
class _Pg8000Range(ranges.AbstractSingleRangeImpl):
    def bind_processor(self, dialect):
        pg8000_Range = dialect.dbApiClient.Range
...
class PGExecutionContext_pg8000(PGExecutionContext):
    def create_server_side_cursor(self):
        ...
        return ServerSideCursor(self._dbApiClient_connection.cursor(), ident)
...
class PGDialect_pg8000(PGDialect):
    ...
    def __init__(self, client_encoding=None, **kwargs):
        ...
        if self._dbApiClient_version < (1, 16, 6):
    ...
    def is_disconnect(self, e, connection, cursor):
        if isinstance(e, self.dbApiClient.InterfaceError) and "network error" in str(
            e
        ):
    ...
    def _set_client_encoding(self, dbApiClient_connection, client_encoding):
        cursor = dbApiClient_connection.cursor()
        cursor.execute(
