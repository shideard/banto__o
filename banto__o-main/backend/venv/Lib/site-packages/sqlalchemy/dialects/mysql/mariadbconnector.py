...
databases using an ApiClient which is compliant with the Python DB ApiClient 2.0 (PEP-249).
...
class MySQLExecutionContext_mariadbconnector(MySQLExecutionContext):
    ...
    def create_server_side_cursor(self) -> DBApiClientCursor:
        return self._dbApiClient_connection.cursor(buffered=False)

    def create_default_cursor(self) -> DBApiClientCursor:
        return self._dbApiClient_connection.cursor(buffered=True)
...
class MySQLDialect_mariadbconnector(MySQLDialect):
    ...
    def _dbApiClient_version(self) -> Tuple[int, ...]:
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        if self.dbApiClient is not None:
            if self._dbApiClient_version < mariadb_cpy_minimum_version:
    ...
    def is_disconnect(
        ...
        if super().is_disconnect(e, connection, cursor):
            return True
        elif isinstance(e, self.loaded_dbApiClient.Error):
            str_e = str(e).lower()
