...
class AsyncAdapt_aiomysql_cursor(AsyncAdapt_dbApiClient_cursor):
    __slots__ = ()

    def _make_new_cursor(
        self, connection: AsyncIODBApiClientConnection
    ) -> AsyncIODBApiClientCursor:
        return connection.cursor(self._adapt_connection.dbApiClient.Cursor)


class AsyncAdapt_aiomysql_ss_cursor(
    AsyncAdapt_dbApiClient_ss_cursor, AsyncAdapt_aiomysql_cursor
):
    __slots__ = ()
    ...
    def _make_new_cursor(
        ...
        return connection.cursor(
            self._adapt_connection.dbApiClient.aiomysql.cursors.SSCursor
        )


class AsyncAdapt_aiomysql_connection(
    AsyncAdapt_terminate, AsyncAdapt_dbApiClient_connection
):
    __slots__ = ()
...
class AsyncAdapt_aiomysql_dbApiClient(AsyncAdapt_dbApiClient_module):
    ...
    def _init_cursors_subclasses(
        self,
    ) -> Tuple[AsyncIODBApiClientCursor, AsyncIODBApiClientCursor]:
        ...
        class Cursor(self.aiomysql.Cursor):  # type: ignore[misc, name-defined]
            async def _show_warnings(
                self, conn: AsyncIODBApiClientConnection
            ) -> None:
                pass
...
class MySQLDialect_aiomysql(MySQLDialect_pymysql):
    ...
    @classmethod
    def import_dbApiClient(cls) -> AsyncAdapt_aiomysql_dbApiClient:
        return AsyncAdapt_aiomysql_dbApiClient(
