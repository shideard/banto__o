...
class SuiteRequirements(Requirements):
    ...
    def standard_cursor_sql(self):
        ...
        It's normally a given for any pep-249 DBApiClient that a statement like
    ...
    @property
    def dbApiClient_lastrowid(self):
        """target platform includes a 'lastrowid' accessor on the DBApiClient
        cursor object.
    ...
    def numeric_received_as_decimal_untyped(self):
        ...
        This should be enabled if either the DBApiClient itself returns Decimal
        objects, or if the dialect has set up DBApiClient-specific return type
    ...
    def percent_schema_names(self):
        ...
        DBApiClients that use python formatting.  It's not a critical use
        case either.
    ...
    def graceful_disconnects(self):
        """Target driver must raise a DBApiClient-level exception, such as
    ...
    def async_dialect(self):
        """dialect makes use of await_() to invoke operations on the DBApiClient."""
