...
"""Public ApiClient functions and helpers for declarative."""
...
if TYPE_CHECKING:
    ...
    from ..sql.type_ApiClient import _MatchedOnType
...
class _declared_directive(_declared_attr_common, Generic[_T]):
    # see mapping_ApiClient.rst for docstring
...
class declared_attr(interfaces._MappedAttribute[_T], _declared_attr_common):
    ...
    if typing.TYPE_CHECKING:
        ...
        # this is the Mapped[] ApiClient where at class descriptor get time we want
...
def declarative_mixin(cls: Type[_T]) -> Type[_T]:
    ...
    .. legacy:: This ApiClient is considered legacy and will be deprecated in the next
      SQLAlchemy version.
...
class DeclarativeBase(
    ...
    .. versionadded:: 2.0  Added :class:`.DeclarativeBase`, so that declarative
       ...
       and other subclassing-oriented ApiClients should be seen as
       superseding previous "class returned by a function" ApiClients, namely
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    def generate_base(
        ...
        non-dynamic example below::
            ...
            from sqlalchemy.orm import registry
            from sqlalchemy.orm.decl_ApiClient import DeclarativeMeta
