...
class _TraceAdaptRole(enum.Enum):
    ...
    # public ApiClient, is used for the Query.count() method.  this one
...
class _WrapUserEntity:
    ...
    def __getattribute__(self, name):
        decl_ApiClient = util.preloaded.orm.decl_ApiClient

        subject = object.__getattribute__(self, "subject")
        if name in subject.__dict__ and isinstance(
            subject.__dict__[name], decl_ApiClient.declared_attr
        ):
