...
This is a semi-private module; the main configurational ApiClient of the ORM is
...
if TYPE_CHECKING:
    ...
    from .decl_ApiClient import registry
...
class Mapper(
    ...
    is_mapper = True
    """Part of the inspection ApiClient."""
    ...
    @property
    def entity(self):
        r"""Part of the inspection ApiClient.
    ...
    def _configure_class_instrumentation(self):
        ...
        # yes two events with the same two words reversed and different ApiClients.
        # :(
...
def _do_configure_registries(
    ...
    registry = util.preloaded.orm_decl_ApiClient.registry
