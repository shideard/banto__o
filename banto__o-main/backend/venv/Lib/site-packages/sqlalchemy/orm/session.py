...
class SessionTransaction(_StateChange, TransactionalContext):
    ...
    .. versionchanged:: 1.4  The scoping and ApiClient methods to work with the
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def commit(self) -> None:
        ...
        ApiClients. The :paramref:`.Session.expire_on_commit` parameter may be used
    ...
    def connection(
        ...
        transactional state is established with the DBApiClient until the first
    ...
    def execute(
        ...
        *,
        ...
        The ApiClient contract of :meth:`_orm.Session.execute` is similar to that
    ...
    def query(
        ...
        .. seealso::
            ...
            :ref:`query_ApiClient_toplevel` - legacy ApiClient doc
    ...
    def bulk_insert_mappings(
        ...
        .. legacy::
            ...
            SQLAlchemy.   For modern bulk INSERT and UPDATE, see
            the sections :ref:`orm_queryguide_bulk_insert` and
            :ref:`orm_queryguide_bulk_update`.  The 2.0 ApiClient shares
        ...
        :param render_nulls: When True, a value of ``None`` will result
         ...
         allows the full set of rows to be batched to the DBApiClient.  Normally,
