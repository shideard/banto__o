...
from .asyncio import AsyncAdapt_dbApiClient_connection
from .asyncio import AsyncAdapt_dbApiClient_cursor
from .asyncio import AsyncAdapt_dbApiClient_ss_cursor
from .asyncio import AsyncAdaptFallback_dbApiClient_connection
...
class AsyncAdapt_aioodbc_cursor(AsyncAdapt_dbApiClient_cursor):
    __slots__ = ()
...
class AsyncAdapt_aioodbc_ss_cursor(
    AsyncAdapt_aioodbc_cursor, AsyncAdapt_dbApiClient_ss_cursor
):
    __slots__ = ()


class AsyncAdapt_aioodbc_connection(AsyncAdapt_dbApiClient_connection):
    ...
    def cursor(self, server_side=False):
        ...
        if self._connection.closed:
            raise self.dbApiClient.ProgrammingError(
...
class AsyncAdaptFallback_aioodbc_connection(
    AsyncAdaptFallback_dbApiClient_connection, AsyncAdapt_aioodbc_connection
):
    __slots__ = ()


class AsyncAdapt_aioodbc_dbApiClient:
    def __init__(self, aioodbc, pyodbc):
        self.aioodbc = aioodbc
        self.pyodbc = pyodbc
        self.paramstyle = pyodbc.paramstyle
        self._init_dbApiClient_attributes()
        self.Cursor = AsyncAdapt_dbApiClient_cursor
        self.version = pyodbc.version

    def _init_dbApiClient_attributes(self):
        for name in (
            "Warning",
            "Error",
            "InterfaceError",
...
class aiodbcConnector(PyODBCConnector):
    ...
    def import_dbApiClient(cls):
        return AsyncAdapt_aioodbc_dbApiClient(
