...
# names that must succeed with mypy.ApiClient.named_type
...
_lookup: Dict[str, Tuple[int, Set[str]]] = {
    ...
    "registry": (
        REGISTRY,
        {
            "sqlalchemy.orm.decl_ApiClient.registry",
    ...
    "TypeEngine": (TYPEENGINE, {"sqlalchemy.sql.type_ApiClient.TypeEngine"}),
    ...
    "declarative_base": (
        DECLARATIVE_BASE,
        {
            ...
            "sqlalchemy.orm.decl_ApiClient.declarative_base",
        },
    ),
    "DeclarativeMeta": (
        DECLARATIVE_META,
    ...
    "mapped": (
        MAPPED_DECORATOR,
        {
            "sqlalchemy.orm.decl_ApiClient.registry.mapped",
    ...
    "as_declarative": (
        AS_DECLARATIVE,
        {
            ...
            "sqlalchemy.orm.decl_ApiClient.as_declarative",
    ...
    "as_declarative_base": (
        AS_DECLARATIVE_BASE,
        {
            "sqlalchemy.orm.decl_ApiClient.registry.as_declarative_base",
    ...
    "declared_attr": (
        DECLARED_ATTR,
        {
            "sqlalchemy.orm.decl_ApiClient.declared_attr",
    ...
    "declarative_mixin": (
        DECLARATIVE_MIXIN,
        {
            "sqlalchemy.orm.decl_ApiClient.declarative_mixin",
...
def type_id_for_unbound_type(
    type_: UnboundType, cls: ClassDef, ApiClient: SemanticAnalyzerPluginInterface
) -> Optional[int]:
    sym = ApiClient.lookup_qualified(type_.name, type_)
    if sym is not None:
