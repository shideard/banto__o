...
def create_async_engine(url: Union[str, URL], **kw: Any) -> AsyncEngine:
    ...
    if async_creator:
        ...
        def creator() -> Any:
            ...
            return sync_engine.dialect.dbApiClient.connect(  # type: ignore
...
class AsyncConnection(  # type:ignore[misc]
    ...
    async def get_raw_connection(self) -> PoolProxiedConnection:
        """Return the pooled DBApiClient-level connection in use by this
        :class:`_asyncio.AsyncConnection`.
        ...
        :attr:`_pool._ConnectionFairy.dbApiClient_connection` refers instead
        to an :class:`_engine.AdaptedConnection` instance that
        adapts the driver connection to the DBApiClient protocol.
    ...
    async def run_sync(
        ...
        **kw: _P.kwargs,
        ...
        .. note::
            ...
            ApiClients which will be properly adapted to the greenlet context.
