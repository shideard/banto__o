    ...
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    def create(
        ...
        :param query: A dictionary of string keys to string values to be passed
          to the dialect and/or the DBApiClient upon connect.   To specify non-string
          parameters to a Python DBApiClient directly, use the
    ...
    def get_driver_name(self) -> str:
        ...
        This is the name that corresponds to the DBApiClient driver in
        use, and is the portion of the :attr:`_engine.URL.drivername`
