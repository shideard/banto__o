...
"""Connection pooling for DB-ApiClient connections.

Provides a number of connection pool implementations for a variety of
usage scenarios and thread behavior requirements imposed by the
application, DB-ApiClient or database itself.

Also provides a DB-ApiClient 2.0 connection proxying mechanism allowing
regular DB-ApiClient connect() methods to be transparently managed by a
