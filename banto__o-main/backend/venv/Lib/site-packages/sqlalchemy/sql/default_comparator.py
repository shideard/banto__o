...
def _boolean_compare(
    ...
    **kwargs: Any,
    ...
    if result_type is None:
        result_type = type_ApiClient.BOOLEANTYPE
...
def _getitem_impl(
    ...
    if (
        isinstance(expr.type, type_ApiClient.INDEXABLE)
        or isinstance(expr.type, type_ApiClient.TypeDecorator)
        and isinstance(expr.type.impl_instance, type_ApiClient.INDEXABLE)
    ):
...
def _match_impl(
    ...
    return _boolean_compare(
        ...
        result_type=type_ApiClient.MATCHTYPE,
        negate_op=(
