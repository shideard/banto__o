...
from .type_ApiClient import to_instance
        ...
        **dialect_kwargs: Any,
        ...
        :param autoincrement: Set up "auto increment" semantics for an
          ...
          * For multiple-row :func:`_sql.insert` constructs invoked with
            ...
            be special ApiClients that may be used to retrieve lists of new
...
def insert_sentinel(
    ...
    *,
    ...
    return Column(
        name=name,
        type_=type_ApiClient.INTEGERTYPE if type_ is None else type_,
        default=(
    ...
    def _autoincrement_column(self) -> Optional[Column[int]]:
        def _validate_autoinc(col: Column[Any], autoinc_true: bool) -> bool:
            if col.type._type_affinity is None or not issubclass(
                ...
                (
                    type_ApiClient.INTEGERTYPE._type_affinity,
                    type_ApiClient.NUMERICTYPE._type_affinity,
                ),
            ):
                if autoinc_true:
                    raise exc.ArgumentError(
