...
"""SQL function ApiClient, factories, and built-in functions."""
...
class _FunctionGenerator:
    ...
    .. note::
        ...
        the DBApiClient-level ``callproc()`` method for fully traditional stored
        procedures.
...
class GenericFunction(Function[_T]):
    ...
    def __init__(
        ...
        self.type = type_ApiClient.to_instance(  # type: ignore
