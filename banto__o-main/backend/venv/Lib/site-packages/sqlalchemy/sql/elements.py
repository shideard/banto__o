...
if typing.TYPE_CHECKING:
    ...
    from .type_ApiClient import TypeEngine
...
def literal(
    ...
    :param value: the value to be bound. Can be any Python object supported by
     the underlying DB-ApiClient, or is translatable via the given type argument.
...
class ClauseElement(
    ...
    def _clone(self, **kw: Any) -> Self:
        ...
        This method may be used by a generative ApiClient.  Its also used as
...
class ColumnElement(
    ...
    functions with regards to SQL expressions are as follows:
        ...
        * a literal Python value, such as a string, integer or floating
          ...
          to the DBApiClient at execution time as a parameterized argument to the
    ...
    def _non_anon_label(self) -> Optional[str]:
        ...
        Above, the two names noted will be what's present in the DBApiClient
    ...
    def self_group(
        ...
        if (
            ...
            and self.type._type_affinity is type_ApiClient.BOOLEANTYPE._type_affinity
        ):
    ...
    def _negate(self) -> ColumnElement[Any]:
        if self.type._type_affinity is type_ApiClient.BOOLEANTYPE._type_affinity:
    ...
    if not TYPE_CHECKING:
        ...
        def type(self) -> TypeEngine[_T]:  # noqa: A001
            ...
            # type_ApiClient
            return type_ApiClient.NULLTYPE
...
class BindParameter(roles.InElementRole, KeyedColumnElement[_T]):
        ...
        if type_ is None:
            if expanding:
                if value:
                    ...
                    check_value = type_ApiClient._NO_VALUE_IN_LIST
            else:
                check_value = value
            if _compared_to_type is not None:
                ...
                self.type = type_ApiClient._resolve_value_to_type(check_value)
    ...
    def _with_value(self, value, maintain_key=False, required=NO_ARG):
        ...
        if cloned.type is type_ApiClient.NULLTYPE:
            cloned.type = type_ApiClient._resolve_value_to_type(value)
        return cloned
    ...
    def render_literal_execute(self) -> BindParameter[_T]:
        ...
        is passed to the DBApiClient.   Dialects in particular may want to use
...
class False_(
    ...
    if not TYPE_CHECKING:
        ...
        @util.memoized_property
        def type(self) -> TypeEngine[_T]:  # noqa: A001
            return type_ApiClient.BOOLEANTYPE
...
class ExpressionClauseList(OperatorExpression[_T]):
    ...
    def __init__(
        ...
        *clauses: _ColumnExpressionArgument[Any],
        ...
        self._is_implicitly_boolean = operators.is_boolean(self.operator)
        self.type = type_ApiClient.to_instance(type_)  # type: ignore
...
class BooleanClauseList(ExpressionClauseList[bool]):
    ...
    def _construct_raw(
        ...
        self.group = True
        self.operator = operator
        self.type = type_ApiClient.BOOLEANTYPE
    ...
    def __init__(
        ...
        *whens: Union[
        ...
        type_ = next(
            ...
            self.else_.type if self.else_ is not None else type_ApiClient.NULLTYPE,
        )
...
class Cast(WrapsColumnExpression[_T]):
    ...
    def __init__(
        ...
        self.type = type_ApiClient.to_instance(type_)
...
class Extract(ColumnElement[int]):
    ...
    def __init__(self, field: str, expr: _ColumnExpressionArgument[Any]):
        self.type = type_ApiClient.INTEGERTYPE
        self.field = field
    ...
    def _negate(self) -> ColumnElement[Any]:
        if self.type._type_affinity is type_ApiClient.BOOLEANTYPE._type_affinity:
            return UnaryExpression(
                ...
                operator=operators.inv,
                type_=type_ApiClient.BOOLEANTYPE,
            )
        else:
...
class Slice(ColumnElement[Any]):
    ...
    def __init__(self, start, stop, step, _name=None):
        self.start = coercions.expect(
            ...
            start,
            name=_name,
            type_=type_ApiClient.INTEGERTYPE,
        )
        ...
        self.type = type_ApiClient.NULLTYPE
...
class Grouping(GroupedElement, ColumnElement[_T]):
    ...
    def __init__(
        ...
        self.type = getattr(element, "type", type_ApiClient.NULLTYPE)  # type: ignore
        self._propagate_attrs = element._propagate_attrs
...
class Label(roles.LabeledColumnExprRole[_T], NamedColumn[_T]):
    ...
    def __init__(
        ...
        self.type = (
            type_ApiClient.to_instance(type_)
...
def _type_from_args(args: Sequence[ColumnElement[_T]]) -> TypeEngine[_T]:
    for a in args:
        ...
        return type_ApiClient.NULLTYPE  # type: ignore
