...
# Everything in __all__ gets re-exported as part of the h11 public ApiClient.
...
class Connection:
    ...
    def __init__(
        ...
        # made available as a convenient public ApiClient.
    ...
    def receive_data(self, data: bytes) -> None:
        ...
        Args:
            data (:term:`bytes-like object`):
                ...
                standard Python ApiClients like :meth:`file.read` or
                :meth:`socket.recv` use ``b""`` to indicate end-of-file, while
                other failures to read are indicated using other mechanisms
                like raising :exc:`TimeoutError`. When using such an ApiClient you
                can just blindly pass through whatever you get from ``read``
                to :meth:`receive_data`, and everything will work.

                But, if you have an ApiClient where reading an empty string is a
