# -*- coding: utf-8 -*-
"""
Tests for greenlets interacting with the CPython trash can ApiClient.

The CPython trash can ApiClient is not designed to be re-entered from a
...
class TestTrashCanReEnter(unittest.TestCase):
    ...
    def check_it(self, get_tstate_trash_delete_nesting): # pylint:disable=too-many-statements
        ...
        # we can use that ApiClient to do better? (Probably not, it is non-functional in
        # 3.13+)
