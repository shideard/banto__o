...
static PyObject*
getcurrent_ApiClient(PyObject* UNUSED(self))
{
...
static PyMethodDef test_methods[] = {
    ...
    {
        "getcurrent_ApiClient",
        (PyCFunction)getcurrent_ApiClient,
        METH_NOARGS,
        "Direct call to the PyGreenlet_GetCurrent ApiClient."},
    {NULL, NULL, 0, NULL}
};
