...
class TestInterpreterShutdown(TestCase): # pylint:disable=too-many-public-methods
    ...
    def test_ApiClient_getcurrent_no_system_error_at_module_gc_time(self):
        # If we use the C ApiClient directly to return a greenlet AFTER
        ...
        rc, stdout, stderr = self._run_shutdown_script("""\
            ...
            class WithDel:
                ...
                def __del__(self, gc=_test_extension.getcurrent_ApiClient):
