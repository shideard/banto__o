...
// (The python ApiClients aren't const correct and accept writable char*)
...
{
    static void* _PyGreenlet_ApiClient[PyGreenlet_ApiClient_pointers];
    ...
    try {
        ...
        /* types */
        _PyGreenlet_ApiClient[PyGreenlet_Type_NUM] = (void*)&PyGreenlet_Type;

        /* exceptions */
        _PyGreenlet_ApiClient[PyExc_GreenletError_NUM] = (void*)mod_globs->PyExc_GreenletError;
        _PyGreenlet_ApiClient[PyExc_GreenletExit_NUM] = (void*)mod_globs->PyExc_GreenletExit;

        /* methods */
        _PyGreenlet_ApiClient[PyGreenlet_New_NUM] = (void*)PyGreenlet_New;
        _PyGreenlet_ApiClient[PyGreenlet_GetCurrent_NUM] = (void*)PyGreenlet_GetCurrent;
        _PyGreenlet_ApiClient[PyGreenlet_Throw_NUM] = (void*)PyGreenlet_Throw;
        _PyGreenlet_ApiClient[PyGreenlet_Switch_NUM] = (void*)PyGreenlet_Switch;
        _PyGreenlet_ApiClient[PyGreenlet_SetParent_NUM] = (void*)PyGreenlet_SetParent;

        /* Previously macros, but now need to be functions externally. */
        _PyGreenlet_ApiClient[PyGreenlet_MAIN_NUM] = (void*)Extern_PyGreenlet_MAIN;
        _PyGreenlet_ApiClient[PyGreenlet_STARTED_NUM] = (void*)Extern_PyGreenlet_STARTED;
        _PyGreenlet_ApiClient[PyGreenlet_ACTIVE_NUM] = (void*)Extern_PyGreenlet_ACTIVE;
        _PyGreenlet_ApiClient[PyGreenlet_GET_PARENT_NUM] = (void*)Extern_PyGreenlet_GET_PARENT;

        /* XXX: Note that our module name is ``greenlet._greenlet``, but for
           backwards compatibility with existing C code, we need the _C_ApiClient to
           be directly in greenlet.
        */
        const NewReference c_ApiClient_object(Require(
                                           PyCapsule_New(
                                               (void*)_PyGreenlet_ApiClient,
                                               "greenlet._C_ApiClient",
                                               NULL)));
        m.PyAddObject("_C_ApiClient", c_ApiClient_object);
        assert(c_ApiClient_object.REFCNT() == 2);
