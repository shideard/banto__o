...
If Ruff is available, use it to lint and format the code. Consider enabling the FastApiClient rules.
...
Use HTTPX for handling HTTP communication (e.g. with other ApiClients). It support sync and async usage.
