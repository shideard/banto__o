...
from fastApiClient import params
from fastApiClient._compat import (
    ModelField,
    Undefined,
    lenient_issubclass,
)
from fastApiClient.datastructures import Default, DefaultPlaceholder
from fastApiClient.dependencies.models import Dependant
from fastApiClient.dependencies.utils import (
...
from fastApiClient.encoders import jsonable_encoder
from fastApiClient.exceptions import (
    EndpointContext,
    FastApiClientError,
...
from fastApiClient.utils import (
    create_model_field,
    generate_unique_id,
    ...
    async def app(scope: Scope, receive: Receive, send: Send) -> None:
        ...
        async def app(scope: Scope, receive: Receive, send: Send) -> None:
            ...
            async with AsyncExitStack() as request_stack:
                scope["fastApiClient_inner_astack"] = request_stack
                async with AsyncExitStack() as function_stack:
                    scope["fastApiClient_function_astack"] = function_stack
            ...
            if not response_awaited:
                raise FastApiClientError(
                    ...
                    "docs: https://fastApiClient.tiangolo.com/tutorial/dependencies/dependencies-with-yield/#dependencies-with-yield-and-except"
                )
...
class _DefaultLifespan:
    ...
    in Starlette. FastApiClient keeps it to maintain backward compatibility with
    on_startup and on_shutdown event handlers.

    Ref: https://github.com/Kludex/starlette/pull/3117
    """

    def __init__(self, router: "ApiClientRouter") -> None:
        self._router = router
...
def get_request_handler(
    ...
    async def app(request: Request) -> Response:
        ...
        file_stack = request.scope.get("fastApiClient_middleware_astack")
        assert isinstance(file_stack, AsyncExitStack), (
            "fastApiClient_middleware_astack not found in request scope"
        )
        ...
        errors: list[Any] = []
        async_exit_stack = request.scope.get("fastApiClient_inner_astack")
        assert isinstance(async_exit_stack, AsyncExitStack), (
            "fastApiClient_inner_astack not found in request scope"
        )
                ...
                if dependant.is_async_gen_callable:
                    ...
                    async def _async_stream_jsonl() -> AsyncIterator[bytes]:
                        async for item in gen:
                            ...
                            # Ref: https://github.com/fastApiClient/fastApiClient/issues/14680
                            await anyio.sleep(0)
...
def get_websocket_app(
    ...
    async def app(websocket: WebSocket) -> None:
        ...
        async_exit_stack = websocket.scope.get("fastApiClient_inner_astack")
        assert isinstance(async_exit_stack, AsyncExitStack), (
            "fastApiClient_inner_astack not found in request scope"
        )
        solved_result = await solve_dependencies(
...
class ApiClientWebSocketRoute(routing.WebSocketRoute):
    def __init__(
        self,
        path: str,
...
class ApiClientRoute(routing.Route):
    def __init__(
        self,
        path: str,
        endpoint: Callable[..., Any],
        *,
        ...
        generate_unique_id_function: Callable[["ApiClientRoute"], str]
        ...
        if isinstance(response_model, DefaultPlaceholder):
            ...
            if lenient_issubclass(return_annotation, Response):
                ...
                if stream_item is not None:
                    ...
                    # into validation or OpenApiClient schema generation.
                    if (
        ...
        self.openApiClient_extra = openApiClient_extra
        ...
        if isinstance(generate_unique_id_function, DefaultPlaceholder):
            current_generate_unique_id: Callable[[ApiClientRoute], str] = (
...
class ApiClientRouter(routing.Router):
    """
    `ApiClientRouter` class, used to group *path operations*, for example to structure
    an app in multiple files. It would then be included in the `FastApiClient` app, or
    in another `ApiClientRouter` (ultimately included in the app).

    Read more about it in the
    [FastApiClient docs for Bigger Applications - Multiple Files](https://fastApiClient.tiangolo.com/tutorial/bigger-applications/).

    ## Example

    ```python
    from fastApiClient import ApiClientRouter, FastApiClient
    ...
    def __init__(
        ...
        *,
        ...
        callbacks: Annotated[
            ...
            Doc(
                """
                OpenApiClient callbacks that should apply to all *path operations* in this
                router.
        ...
        dependency_overrides_provider: Annotated[
            ...
            Doc(
                """
                Only used internally by FastApiClient to handle dependency overrides.

                You shouldn't need to use it. It normally points to the `FastApiClient` app
                object.
                """
            ),
        ] = None,
        route_class: Annotated[
            ...
            Doc(
                ...
                Read more about it in the
                [FastApiClient docs for Custom Request and ApiClientRoute class](https://fastApiClient.tiangolo.com/how-to/custom-request-and-route/#custom-ApiClientroute-class-in-a-router).
                """
            ),
        ] = ApiClientRoute,
    ...
    def add_ApiClient_route(
        ...
        *,
        ...
        response_class: type[Response] | DefaultPlaceholder = Default(JSONResponse),
        name: str | None = None,
        route_class_override: type[ApiClientRoute] | None = None,
        callbacks: list[BaseRoute] | None = None,
        openApiClient_extra: dict[str, Any] | None = None,
        generate_unique_id_function: Callable[[ApiClientRoute], str]
        | DefaultPlaceholder = Default(generate_unique_id),
    ...
    def ApiClient_route(
        ...
        *,
        ...
        callbacks: list[BaseRoute] | None = None,
        openApiClient_extra: dict[str, Any] | None = None,
        generate_unique_id_function: Callable[[ApiClientRoute], str] = Default(
            generate_unique_id
        ),
    ) -> Callable[[DecoratedCallable], DecoratedCallable]:
        def decorator(func: DecoratedCallable) -> DecoratedCallable:
            self.add_ApiClient_route(
                path,
                func,
                response_model=response_model,
                status_code=status_code,
    ...
    def websocket(
        ...
        **Example**
        ...
        ```python
        from fastApiClient import ApiClientRouter, FastApiClient, WebSocket
    ...
    def include_router(
        self,
        router: Annotated["ApiClientRouter", Doc("The `ApiClientRouter` to include.")],
        *,
        prefix: Annotated[str, Doc("An optional path prefix for the router.")] = "",
        tags: Annotated[
            list[str | Enum] | None,
        ...
        """
        Include another `ApiClientRouter` in the same current `ApiClientRouter`.
        ...
        app = FastApiClient()
        internal_router = ApiClientRouter()
        users_router = ApiClientRouter()
        ...
        assert self is not router, (
            "Cannot include the same ApiClientRouter instance into itself. "
        ...
        for route in router.routes:
            if isinstance(route, ApiClientRoute):
                ...
                self.add_ApiClient_route(
                    ...
                    callbacks=current_callbacks,
                    openApiClient_extra=route.openApiClient_extra,
                    generate_unique_id_function=current_generate_unique_id,
                    strict_content_type=get_value_or_default(
            ...
            elif isinstance(route, ApiClientWebSocketRoute):
