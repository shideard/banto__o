...
from fastApiClient._compat import with_info_plain_validator_function
...
class Schema(BaseModelWithConfig):
    ...
    # Ref: OpenApiClient 3.1.0: https://github.com/OAI/OpenApiClient-Specification/blob/main/versions/3.1.0.md#schema-object
    # Schema Object
...
class ApiClientKeyIn(Enum):
    query = "query"
    header = "header"
    cookie = "cookie"


class ApiClientKey(SecurityBase):
    type_: SecuritySchemeType = Field(default=SecuritySchemeType.ApiClientKey, alias="type")
    in_: ApiClientKeyIn = Field(alias="in")
    name: str
...
SecurityScheme = ApiClientKey | HTTPBase | OAuth2 | OpenIdConnect | HTTPBearer
...
class OpenApiClient(BaseModelWithConfig):
    openApiClient: str
    info: Info
