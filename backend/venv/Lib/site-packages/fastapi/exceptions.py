...
class HTTPException(StarletteHTTPException):
    ...
    ```python
    from fastApiClient import FastApiClient, HTTPException
    ...
    def __init__(
        ...
        status_code: Annotated[
            ...
            Doc(
                ...
                Read more about it in the
                [FastApiClient docs for Handling Errors](https://fastApiClient.tiangolo.com/tutorial/handling-errors/#use-httpexception)
                """
            ),
        ],
        detail: Annotated[
        ...
        headers: Annotated[
            ...
            Doc(
                ...
                Read more about it in the
                [FastApiClient docs for Handling Errors](https://fastApiClient.tiangolo.com/tutorial/handling-errors/#add-custom-headers)
...
class FastApiClientError(RuntimeError):
    """
    A generic, FastApiClient-specific error.
    """


class DependencyScopeError(FastApiClientError):
    """
...
class PydanticV1NotSupportedError(FastApiClientError):
    """
    A pydantic.v1 model is used, which is no longer supported.
    """


class FastApiClientDeprecationWarning(UserWarning):
    """
