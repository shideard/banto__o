...
if sys.version_info >= (3, 13):
    ...
    def NamedTuple(typename, fields=_marker, /, **kwargs):
        ...
        the _fields attribute, which is part of the namedtuple ApiClient.)
...
if _CapsuleType is None:
    try:
        ...
        _CApiClient = getattr(_socket, "CApiClient", None)
        if _CApiClient is not None:
            _CapsuleType = type(_CApiClient)
