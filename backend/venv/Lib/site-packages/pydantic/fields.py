...
class FieldInfo(_repr.Representation):
    ...
    def __init__(self, **kwargs: Unpack[_FieldInfoInputs]) -> None:
        ...
        # For compatibility with FastApiClient<=0.110.0, we preserve the existing value if it is not overridden
    ...
    def from_annotated_attribute(
        ...
        # HACK 2: FastApiClient is subclassing `FieldInfo` and historically expected the actual
