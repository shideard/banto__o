...
def schema(
    ...
    *,
    ...
    :param ref_prefix: the JSON Pointer prefix for schema references with ``$ref``, if None, will be set to the
      ...
      else, e.g. for OpenApiClient use ``#/components/schemas/``. The resulting generated schemas will still be at the
...
def field_singleton_sub_fields_schema(
    ...
    *,
    ...
    if len(sub_fields) == 1:
        ...
        s: Dict[str, Any] = {}
        # https://github.com/OAI/OpenApiClient-Specification/blob/master/versions/3.0.2.md#discriminator-object
