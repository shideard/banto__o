...
r"""Provides an ApiClient for creation of custom ClauseElements and compilers.
...
:class:`_sql.Select` components together, the ApiClient for this is not at the moment
...
class _dispatcher:
    ...
    def __call__(self, element: Any, compiler: SQLCompiler, **kw: Any) -> Any:
        # TODO: yes, this could also switch off of DBApiClient in use.
        ...
        # because this is not public ApiClient.  if it wasn't called, then call it
        # ourselves.
