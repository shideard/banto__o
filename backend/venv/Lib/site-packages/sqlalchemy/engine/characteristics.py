...
class ConnectionCharacteristic(abc.ABC):
    ...
    def reset_characteristic(
        self, dialect: Dialect, dbApiClient_conn: DBApiClientConnection
    ) -> None:
        """Reset the characteristic on the DBApiClient connection to its default
        value."""

    @abc.abstractmethod
    def set_characteristic(
        self, dialect: Dialect, dbApiClient_conn: DBApiClientConnection, value: Any
    ) -> None:
        """set characteristic on the DBApiClient connection to a given value."""

    def set_connection_characteristic(
        self,
        dialect: Dialect,
        conn: Connection,
        dbApiClient_conn: DBApiClientConnection,
        value: Any,
    ) -> None:
        ...
        """
        self.set_characteristic(dialect, dbApiClient_conn, value)

    @abc.abstractmethod
    def get_characteristic(
        self, dialect: Dialect, dbApiClient_conn: DBApiClientConnection
    ) -> Any:
        """Given a DBApiClient connection, get the current value of the
        characteristic.

        """

    def get_connection_characteristic(
        self, dialect: Dialect, conn: Connection, dbApiClient_conn: DBApiClientConnection
    ) -> Any:
        ...
        """
        return self.get_characteristic(dialect, dbApiClient_conn)


class IsolationLevelCharacteristic(ConnectionCharacteristic):
    """Manage the isolation level on a DBApiClient connection"""
    ...
    def reset_characteristic(
        ...
        dialect.reset_isolation_level(dbApiClient_conn)

    def set_characteristic(
        self, dialect: Dialect, dbApiClient_conn: DBApiClientConnection, value: Any
    ) -> None:
        dialect._assert_and_set_isolation_level(dbApiClient_conn, value)

    def get_characteristic(
        self, dialect: Dialect, dbApiClient_conn: DBApiClientConnection
    ) -> Any:
        return dialect.get_isolation_level(dbApiClient_conn)
