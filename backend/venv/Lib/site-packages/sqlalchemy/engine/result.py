...
"""represents the kind of row we get from a DBApiClient cursor"""
        ...
        if self._unique_filter_state:
            ...
            def manyrows(
                ...
                if num is None:
                    ...
                    # manyrows number, DBApiClient has this as cursor.arraysize
                    # different DBApiClients / fetch strategies may be different.
...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    def yield_per(self, num: int) -> Self:
        ...
        use of a server side cursor, if the DBApiClient supports a specific "server
    ...
    def partitions(
        ...
        which instructs both the DBApiClient driver to use server side cursors,
    ...
    def first(self) -> Optional[Row[_TP]]:
        ...
        .. note::  This method returns one **row**, e.g. tuple, by default.
           ...
           :class:`_engine.Result`;
           for a DBApiClient driver that buffers results in memory before yielding
...
class FilterResult(ResultInternal[_R]):
    ...
    ApiClients including :class:`_engine.MappingResult`,
