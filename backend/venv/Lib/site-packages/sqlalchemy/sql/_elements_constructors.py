...
def bindparam(
    ...
    to the :term:`DBApiClient` as values which need to be correctly escaped
    ...
    :param value:
      ...
      DBApiClient, if no other value is indicated to the statement execution
    ...
    :param expanding:
      ...
      with a variable number of parameter slots passed to the DBApiClient.
    ...
    :param literal_execute:
      ...
      dictionary / list passed to DBApiClient ``cursor.execute()``.  This
      ...
      the DBApiClient ``cursor.execute()`` method, rather than when the statement
...
def tuple_(
    *clauses: _ColumnExpressionArgument[Any],
    ...
    .. warning::
        ...
        :class:`~sqlalchemy.exc.DBApiClientError` when such an expression is
        invoked.
