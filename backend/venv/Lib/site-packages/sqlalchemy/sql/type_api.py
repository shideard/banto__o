...
class TypeEngine(Visitable, Generic[_T]):
    ...
    def result_processor(
        ...
        :param coltype: DBApiClient coltype argument received in cursor.description.
    ...
    def get_dbApiClient_type(self, dbApiClient: DBApiClientModule) -> Optional[Any]:
        """Return the corresponding type object from the underlying DB-ApiClient, if
        any.
    ...
    def python_type(self) -> Type[Any]:
        ...
        DBApiClients (like ``int`` for example), will return that type.
    ...
    def _resolve_for_literal(self, value: Any) -> Self:
        ...
        TODO: this should be part of public ApiClient
    ...
    def _cached_result_processor(
        ...
        # raises
        d = self._dialect_info(dialect)
        # key assumption: DBApiClient type codes are
    ...
    def coerce_compared_value(
        ...
        needed by the DBApiClient to both ides. It also provides the public method
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    # this is that pattern I've used in a few places (Dialect.dbApiClient,
    ...
    def get_dbApiClient_type(self, dbApiClient: DBApiClientModule) -> Optional[Any]:
        """Return the DBApiClient type object represented by this
        :class:`.TypeDecorator`.

        By default this calls upon :meth:`.TypeEngine.get_dbApiClient_type` of the
        underlying "impl".
        """
        return self.impl_instance.get_dbApiClient_type(dbApiClient)
