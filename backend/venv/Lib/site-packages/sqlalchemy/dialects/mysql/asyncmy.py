...
class AsyncAdapt_asyncmy_cursor(AsyncAdapt_dbApiClient_cursor):
    __slots__ = ()


class AsyncAdapt_asyncmy_ss_cursor(
    AsyncAdapt_dbApiClient_ss_cursor, AsyncAdapt_asyncmy_cursor
):
    __slots__ = ()
    ...
    def _make_new_cursor(
        ...
        return connection.cursor(
            self._adapt_connection.dbApiClient.asyncmy.cursors.SSCursor
        )
...
class AsyncAdapt_asyncmy_connection(
    ...
    def _handle_exception(self, error: Exception) -> NoReturn:
        if isinstance(error, AttributeError):
            raise self.dbApiClient.InternalError(
...
class AsyncAdapt_asyncmy_dbApiClient(AsyncAdapt_dbApiClient_module):
...
class MySQLDialect_asyncmy(MySQLDialect_pymysql):
    ...
    def import_dbApiClient(cls) -> DBApiClientModule:
        return AsyncAdapt_asyncmy_dbApiClient(__import__("asyncmy"))
