...
.. versionchanged:: 2.0.39
    ...
    latest version of this DBApiClient.   Previously, MySQL Connector/Python
...
class MySQLDialect_mysqlconnector(MySQLDialect):
    ...
    def import_dbApiClient(cls) -> DBApiClientModule:
        return cast("DBApiClientModule", __import__("mysql.connector").connector)

    def do_ping(self, dbApiClient_connection: DBApiClientConnection) -> bool:
        dbApiClient_connection.ping(False)
        return True
    ...
    def is_disconnect(
        ...
        exceptions = (
            self.loaded_dbApiClient.OperationalError,  #
            self.loaded_dbApiClient.InterfaceError,
            self.loaded_dbApiClient.ProgrammingError,
        )
