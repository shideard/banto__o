...
The PyMySQL DBApiClient accepts the same SSL arguments as that of MySQLdb,
...
The pymysql DBApiClient is a pure Python port of the MySQL-python (MySQLdb) driver,
