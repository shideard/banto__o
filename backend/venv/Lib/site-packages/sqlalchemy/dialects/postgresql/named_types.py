...
class ENUM(NamedType, type_ApiClient.NativeForEmulated, sqltypes.Enum):
    ...
    def coerce_compared_value(self, op, value):
        ...
        if (
            ...
            is type_ApiClient.STRINGTYPE._type_affinity
        ):
            return self
        else:
    ...
    def adapt_emulated_to_native(cls, impl, **kw):
        ...
        if type_ApiClient._is_native_for_emulated(impl.__class__):
    ...
    def get_dbApiClient_type(self, dbApiClient: ModuleType) -> None:
        """dont return dbApiClient.STRING for ENUM in PostgreSQL, since that's
        a different type"""
...
class DOMAIN(NamedType, sqltypes.SchemaType):
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        """
        self.data_type = type_ApiClient.to_instance(data_type)
