...
class _PGExecutionContext_common_psycopg(PGExecutionContext):
    def create_server_side_cursor(self):
        ...
        return self._dbApiClient_connection.cursor(ident)
...
class _PGDialect_common_psycopg(PGDialect):
    ...
    def detect_autocommit_setting(self, dbApiClient_connection):
        return bool(dbApiClient_connection.autocommit)

    def do_ping(self, dbApiClient_connection):
        before_autocommit = dbApiClient_connection.autocommit
        ...
        try:
            ...
            cursor.close()
            if not before_autocommit and not dbApiClient_connection.closed:
                dbApiClient_connection.autocommit = before_autocommit
