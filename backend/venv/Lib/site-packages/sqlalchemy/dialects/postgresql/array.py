...
if TYPE_CHECKING:
    ...
    from ...sql.type_ApiClient import _LiteralProcessorType
...
class ARRAY(sqltypes.ARRAY[_T]):
    ...
    def __init__(
        ...
        :param as_tuple=False: Specify whether return results
          should be converted to tuples from lists. DBApiClients such
    ...
    class Comparator(sqltypes.ARRAY.Comparator[_CT]):
        ...
        def contains(
            ...
            kwargs may be ignored by this operator but are required for ApiClient
            conformance.
            """
