...
The SQLAlchemy ``aiosqlite`` DBApiClient establishes the connection pool differently
...
from ... import pool
from ... import util
from ...connectors.asyncio import AsyncAdapt_dbApiClient_module
...
if TYPE_CHECKING:
    ...
    from ...connectors.asyncio import AsyncIODBApiClientCursor
...
class AsyncAdapt_aiosqlite_cursor:
    ...
    def __init__(self, adapt_connection: AsyncAdapt_aiosqlite_connection):
        ...
        self.arraysize = 1
        self.rowcount = -1
        self.description: Optional[_DBApiClientCursorDescription] = None
    ...
    def execute(
        ...
        try:
            _cursor: AsyncIODBApiClientCursor = self.await_(self._connection.cursor())  # type: ignore[arg-type] # noqa: E501
...
class AsyncAdapt_aiosqlite_ss_cursor(AsyncAdapt_aiosqlite_cursor):
    ...
    def __init__(self, *arg: Any, **kw: Any) -> None:
        ...
        self._cursor: Optional[AsyncIODBApiClientCursor] = None
...
class AsyncAdapt_aiosqlite_connection(AsyncAdapt_terminate, AdaptedConnection):
    ...
    __slots__ = ("dbApiClient",)

    def __init__(self, dbApiClient: Any, connection: AsyncIODBApiClientConnection) -> None:
    ...
    def close(self) -> None:
        try:
            ...
            # both not customary for DBApiClient and is also not a DBApiClient.Error
    ...
    def _handle_exception(self, error: Exception) -> NoReturn:
        if (
            ...
            raise self.dbApiClient.sqlite.OperationalError(
    ...
    def _terminate_force_close(self) -> None:
        ...
        try:
            ...
            raise NotImplementedError(
                "terminate_force_close() not implemented by this DBApiClient shim"
            ) from ae
        else:
            meth()
...
class AsyncAdapt_aiosqlite_dbApiClient(AsyncAdapt_dbApiClient_module):
    def __init__(self, aiosqlite: ModuleType, sqlite: ModuleType):
        self.aiosqlite = aiosqlite
        self.sqlite = sqlite
        self.paramstyle = "qmark"
        self.has_stop = hasattr(aiosqlite.Connection, "stop")
        self._init_dbApiClient_attributes()

    def _init_dbApiClient_attributes(self) -> None:
        for name in (
            "DatabaseError",
            "Error",
            "IntegrityError",
...
class SQLiteExecutionContext_aiosqlite(SQLiteExecutionContext):
    def create_server_side_cursor(self) -> DBApiClientCursor:
        return self._dbApiClient_connection.cursor(server_side=True)
...
class SQLiteDialect_aiosqlite(SQLiteDialect_pysqlite):
    ...
    def __init__(self, **kwargs: Any):
        ...
        if self.dbApiClient and not self.dbApiClient.has_stop:
            self.has_terminate = False

    @classmethod
    def import_dbApiClient(cls) -> AsyncAdapt_aiosqlite_dbApiClient:
        return AsyncAdapt_aiosqlite_dbApiClient(
    ...
    def is_disconnect(
        ...
        self.dbApiClient = cast("DBApiClientModule", self.dbApiClient)
        if isinstance(
            e, self.dbApiClient.OperationalError
    ...
    def get_driver_connection(
        self, connection: DBApiClientConnection
    ) -> AsyncIODBApiClientConnection:
    ...
    def do_terminate(self, dbApiClient_connection: DBApiClientConnection) -> None:
        dbApiClient_connection.terminate()
