...
class Query(
    ...
    .. legacy:: The ORM :class:`.Query` object is a legacy construct
       ...
       :ref:`query_ApiClient_toplevel` for an overview, including links to migration
       documentation.
    ...
    def __init__(
        ...
        # for the query(Entity).with_session(session) ApiClient which is likely in
    ...
    def yield_per(self, count: int) -> Self:
        ...
        (e.g. approximately 1000) is used, even with DBApiClients that buffer
        rows (which are most).
    ...
    def column_descriptions(self) -> List[ORMColumnDescription]:
        ...
        .. seealso::
            ...
            This ApiClient is available using :term:`2.0 style` queries as well,
            documented at:
