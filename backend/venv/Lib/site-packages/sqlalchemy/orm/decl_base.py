...
if TYPE_CHECKING:
    ...
    from .decl_ApiClient import declared_attr
...
@util.preload_module("sqlalchemy.orm.decl_ApiClient")
def _is_declarative_props(obj: Any) -> bool:
    _declared_attr_common = util.preloaded.orm_decl_ApiClient._declared_attr_common
...
class _ClassScanMapperConfig(_MapperConfig):
    ...
    def __init__(
        ...
        # stay far away from any off-label use of dataclasses ApiClients.
...
def _as_dc_declaredattr(
    ...
    decl_ApiClient = util.preloaded.orm_decl_ApiClient
    obj = field_metadata[sa_dataclass_metadata_key]
    if callable(obj) and not isinstance(obj, decl_ApiClient.declared_attr):
        return decl_ApiClient.declared_attr(obj)
    else:
        return obj
